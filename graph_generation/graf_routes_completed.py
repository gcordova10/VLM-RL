...
REFERENCE_STEP = 999228  # paso de referencia mostrado en TensorBoard
...
def main():
    ...
    plt.ylabel("Routes Completed")
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.legend(legend_texts, loc="upper left", frameon=False, fontsize=9)

    out_file = os.path.join(OUTPUT_DIR, "routes_completed_comparison_refstep.png")
    plt.tight_layout()
