...
def main():
    global RUN_MAP, OUTPUT_DIR
    parser = argparse.ArgumentParser(description="Generar gráficos del paper comparando dos runs.")
    ...
    # Actualizamos rutas y configuramos salida
    OUTPUT_DIR = args.out_dir
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    
    RUN_MAP = {
        args.path1: "VLM–RL (baseline)",
        args.path2: "CLG–Smooth (ours)",
    }
