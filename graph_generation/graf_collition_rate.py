...
# Paso de referencia mostrado en TensorBoard (ejemplo: 999228)
REFERENCE_STEP = 999228  
...
def main():
    ...
    plt.legend(legend_texts, loc="lower right", frameon=False, fontsize=9)

    out_file = os.path.join(OUTPUT_DIR, "collision_rate_comparison_refstep.png")
    plt.tight_layout()
    plt.savefig(out_file, dpi=300, facecolor="white")
    plt.show()
    print(f"✅ Garáfico guardado en: {out_file}")
